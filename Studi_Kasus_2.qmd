...
Sebelumnya pada Studi Kasus 1, kita telah melakukan klasifikasi gambar secara menyeluruh. Pada Studi Kasus 2 ini, kita akan mengimplementasikan algoritma deteksi wajah Haar Cascade. Pada Studi Kasus kedua ini kita akan membuat project **Sistem Deteksi dan Pengenalan Wajah** dengan menggunakan 2 metode yang berbeda, yaitu:   
...
for (x, y, w, h) in faces:
    ...
    plt.show()  
```      
Kode diatas adalah contoh implementasi dari Haar Cascade yang dapat secara otomatis mendeteksi wajah. Hasil dari deteksi wajah dapat dilihat pada **Gambar 1. Hasil Deteksi Haar Cascade**.    

<div style="text-align:center">  
::: {layout-ncol="3"}  
![](Asset/prepro1.png)    

![Gambar 1. Hasil Deteksi Haar Cascade](Asset/prepro2.png)    
...
![Gambar 2. Citra Sebelum di Standarisasi](Asset/prepro4.png)    

![Gambar 3. Citra Setelah di Standarisasi](Asset/prepro5.png)      
...
**Metode Evaluasi**   
<div style="text-align:center">
![](https://dataq.files.wordpress.com/2013/06/rumus.png)  
</div>  
...
<div style="text-align:center">
![Klassifikasi Report](Asset/classreport_knn.png)  
</div> 
...
## Haar Cascade - SIFT - BoVW - K-Nearest Neighbors      
...
<div style="text-align:center">
![](Asset/plt_sift_knndistance.png)  
</div>  
...
<div style="text-align:center">
![](Asset/classreport_sift_knn.png)  
</div>
...
```python
import pickle
pickle.dump(model, open('model_haar_sift_knn.pkl', 'wb')) #simpan dalam file.pkl
